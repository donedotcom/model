...
//
// `fillHoles` is a bool that determines whether or not any holes
// found in the path should be filled (i.e., blank objects) created
...
exports.resource = function (path, context, fillHoles) {
  ...
  _.each(steps, function (step) {
    if (resource) {
      if (isErrorModel) {
        resource = resource.errors[step][0];
      } else {
        tempObj = {};
        tempObj[step] = {};
