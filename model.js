var DoneModel = (function () { var defined = {};defined.underscore = { _ : _ };defined['./oo'] = (function () { var module = { exports : {} }; var exports = module.exports;// -------------------------------------------------------------------------79
...
var modelFunctions = {
  ...
  //
  // @param hook The hook location; one of [afterSet]
...
return module.exports; }());function require(name) { return defined[name]; } return defined["./model"]; }());